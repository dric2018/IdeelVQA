...
def make_vocab_questions(input_dir):
    ...
    for dataset in datasets:    
        ...
        print(f"[INFO] In {dataset}")
        for iquestion, question in enumerate(tqdm(questions, desc="Making vocab qsts")):
...
def make_vocab_answers(input_dir, n_answers):
    ...
    for dataset in datasets:
        ...
        print(f"[INFO] In {dataset}")
        for annotation in tqdm(annotations, desc="Making vocab ansrs"):
